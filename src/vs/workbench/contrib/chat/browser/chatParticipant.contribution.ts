...
// NEXORA: Commented out - unused after disabling chat panel
...
// NEXORA: Disable built-in Chat container - Nexora uses its own chat panel in the sidebar
...
// NEXORA: Disable built-in Chat panel - Nexora uses its own chat panel
